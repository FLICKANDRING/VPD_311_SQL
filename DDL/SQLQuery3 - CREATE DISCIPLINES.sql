...
CREATE TABLE DisciplinesDiractionRelation
(
	discipline	SMALLINT,
	diraction	TINYINT,
	PRIMARY KEY	(discipline, diraction),
	CONSTRAINT FK_DDR_Disciplines	FOREIGN KEY	(discipline)	REFERENCES	Disciplines (discipline_id),
	CONSTRAINT FK_DDR_Directions		FOREIGN KEY	(diraction)		REFERENCES	Diractions (diraction_id)
);
GO